...
-- Keymap to open file explorer (:Ex)
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'php', 'typescript', 'javascript', 'css', 'python', 'go', 'gitcommit', 'gitignore', 'json', 'sql', 'tsx' },
